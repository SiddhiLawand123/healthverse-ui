...
export default function RegisterPatientScreen() {
  ...
  const isFormValid = formData.name.trim() && formData.dob.trim() && formData.gender;
  ...
  const handleRegister = async () => {
    ...
    try {
      const response = await authFlowService.registerPatient(phone as string, formData);
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={styles.subtitle}>Complete your patient registration</Text>
          </MotiView>
          ...
          >
            ...
            >
              <LinearGradient
                colors={!isFormValid || loading ? ['#334155', '#1e293b'] : ['#3b82f6', '#2563eb']}
