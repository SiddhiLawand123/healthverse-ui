...
export default function RegisterLabScreen() {
  ...
  const isFormValid = formData.labName.trim() && formData.ownerName.trim() && formData.address.trim();
  ...
  const handleRegister = async () => {
    ...
    try {
      const response = await authFlowService.registerLab(phone as string, formData);
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={styles.subtitle}>Complete your laboratory profile</Text>
          </MotiView>
          ...
          >
            ...
            >
              <LinearGradient
                colors={!isFormValid || loading ? ['#334155', '#1e293b'] : ['#f59e0b', '#d97706']}
